...
description: Detect and prevent prompt injection attacks in AI systems.
...
**Source:** 3rd-party (Rebuff SDK)

## When to Use This Skill

Use this skill when:

- **Prompt Injection Detection Assessment tasks** - Working on detect and prevent prompt injection attacks in ai systems
...
Detect and prevent prompt injection attacks in AI systems. Analyze input patterns, implement detection heuristics, and establish guardrails against adversarial prompting techniques.
...
**Source Type:** 3rd-party (Rebuff SDK)
**Category:** Cybersecurity
